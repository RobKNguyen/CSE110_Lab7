...
const router = new Router(function () {
   ...
   */
  //console.log(document.getElementsByClassName("section--recipe-cards")[0].classList);
  //console.log(document.getElementsByClassName("section--recipe-cards").classList);
  document.getElementsByClassName("section--recipe-cards")[0].classList.add("shown");
  document.getElementsByClassName("section--recipe-expand")[0].classList.remove("shown");
